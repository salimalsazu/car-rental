        ...
        <div className='flex justify-center items-center text-left mt-20'>
            <div className=' w-full lg:w-2/3 flex flex-col'>
                ...
                <div className='flex flex-col lg:flex-row gap-4 '>
                    <button className='bg-orange-400 shadow-lg  text-white px-8 py-3 rounded-sm' >Book Ride</button>
                    <button className='bg-black text-white px-8 py-3 rounded-sm' >Learn More</button>
                </div>
            </div>
